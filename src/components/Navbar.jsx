...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[70px] flex justify-between items-center px-3 bg-[#0c0c0c] text-white text-lg cursor-pointer'>
        {/* logo */}
        <div>
        ...
        <ul className='hidden md:flex'>
         ...
         <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-purple-800 flex flex-col justify-center items-center'}>
            ...
            <li className='py-6 text-2xl'><Link onClick={handleClick} to="skills"  smooth={true} duration={500}>
              Skills
              </Link></li>
            <li className='py-6 text-2xl'><Link onClick={handleClick} to="work"  smooth={true} duration={500}>
              Work
              </Link></li>
